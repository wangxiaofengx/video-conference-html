...
class UserInfo {
	...
	async connect(userInfo) {
		...
		let dataChannel = connect.createDataChannel('sendDataChannel', null);
	...
	download(file, process) {
		return new Promise(async (resolve, reject) => {
			...
			if (!fileChannel) {
				const dataChannel = this.getConnect().createDataChannel('sendFileChannel', null);
	...
	async transferFile(message) {
		...
		if (!fileChannel) {
			fileChannel = this.getConnect().createDataChannel('sendFileChannel', null);
